const defaultProducts = {
    drinks: [
        { id: "Айс-ти тропик", name: "Айс-ти тропик", price: 22, image: "contant/Напитки/Айс-ти тропик.png", description: "Тестовый фрагмент для проверки длины. Этот текст создан случайно, чтобы показать объем примерно в двести символов. Важно отметить, что такие блоки часто используют разработчики и дизайнеры для оценки макетовТестовый фрагмент для проверки длины. Этот текст создан случайно, чтобы показать объем примерно в двести символов. Важно отметить, что такие блоки часто используют разработчики и дизайнеры для оценки макетов" },
        { id: "Айс-ти ягодный", name: "Айс-ти ягодный", price: 22, image: "contant/Напитки/Айс-ти ягодный.png", },
        { id: "Айс-ти аки-гава", name: "Айс-ти аки-гава", price: 22, image: "contant/Напитки/Айс-ти аки-гава.png", },
